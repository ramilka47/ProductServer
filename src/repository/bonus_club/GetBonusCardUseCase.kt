...
class GetBonusCardUseCase(private val bonusCardDao: BonusCardDao,
                          ...
                          private val getBonusCountUseCase: GetBonusCountUseCase) : UseCase<IdRequest, GetBonusCardResponse>{

    override suspend fun getResponse(request: IdRequest, token: String?): GetBonusCardResponse {
